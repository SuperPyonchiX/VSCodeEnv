...
- **プロンプト**: [generate-procedure-document.prompt.md](../prompts/generate-procedure-document.prompt.md) - 手順書生成の詳細手順
- **Markdownガイド**: [markdown.instructions.md](../instructions/markdown.instructions.md) - Markdown記法
- **参考資料**:
